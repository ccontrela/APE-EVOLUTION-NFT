...
contract HAZDEMBZ2 is ERC721ABurnable, Royalty {
    // Utils
    ...
    // ERC721 Metadata
    string private _baseURI_ = "https://web3-api-h5pd2zuvza-uc.a.run.app/";
    ...
    constructor(address signerAddress_, address aaaContract_)
        ERC721ABurnable("HAZDEMBZ1", "HAZDEMBZ1", MAX_BATCH_MINT)
        Royalty(0x1234aBCD1234ABCd1234abcD1234ABCd1234aBCD, 750) // AAA owner recieves 7.50%
    {
    ...
    // Test State
    function setSaleState(uint256 state_) public onlyOwner {
